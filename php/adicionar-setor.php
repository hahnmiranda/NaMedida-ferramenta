...
<div class="row">
	<div class="col s12 m6 push-m3">
		...
		<form action="create.php" method="POST">
			...
			<button type="submit" name="btn-cadastrar-setor" class="btn waves-effect waves-light blue"><i class="material-icons left">save</i> Cadastrar </button>
